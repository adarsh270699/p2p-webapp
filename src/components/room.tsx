...
import { setIsDcConnected } from "@/store/slices/ftSlice";
import { setInFlightState } from "@/store/slices/inFlightSlice";
import {
  initSignal,
  initTransfer,
...
export function Room() {
  ...
  const fileTransferCallBack = (inFlightState: InFlightState) => {
    dispatch(setInFlightState({ ...inFlightState }));
  };
