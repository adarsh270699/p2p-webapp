...
let from: string = "";
let socket: Socket;
let fileTransferCallBack: (fileTransferState: FileTransferState) => void;
...
const initTransferCallbacks = (
    newFileTransferCallBack: (fileTransferState: FileTransferState) => void,
